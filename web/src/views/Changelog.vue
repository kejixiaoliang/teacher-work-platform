...
const releases = [
  {
    version: '0.7.0', date: '2026-08-25', title: '成绩持久化与上手指南优化',
    summary: '修复成绩管理返回页面后内容消失的问题，并保留 v0.6.0 隐私模式与教师访问控制。',
    entries: ['成绩管理首次进入和路由返回时会自动重新加载考试、学生和已保存成绩。', '班级设置新增显式“备份”入口，删除班级前仍会自动下载班级备份作为安全兜底。', '使用指南补充所有模块的用途、操作顺序、备份恢复流程和覆盖风险说明。'],
  },
  {
