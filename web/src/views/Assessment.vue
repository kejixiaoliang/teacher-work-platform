...
.assessment-actions .row-btn, .rule-actions .row-btn { flex:0 0 76px; width:76px; justify-content:center; margin:0 !important; padding:3px 3px; min-height:27px; border:2px solid var(--ink); border-radius:999px; box-shadow:2px 2px 0 var(--ink); background:#fffdf4; font-size:11px; }
...
.stream-card :deep(.el-table__fixed-right), .rule-card :deep(.el-table__fixed-right) { box-shadow:-3px 0 0 rgba(32,27,23,.06); }
