...
.assessment-actions .row-btn, .rule-actions .row-btn { flex:0 0 auto; margin:0 !important; padding:3px 7px; min-height:27px; border:2px solid var(--ink); border-radius:999px; box-shadow:2px 2px 0 var(--ink); background:#fffdf4; font-size:11px; }
